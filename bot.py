...
:globe_with_meridians: **Total Confirmed Cases:** {data['TotalConfirmed']}

:red_circle: **Total Deaths:** {data['TotalDeaths']}

:green_circle: **Total Recoveries:** {data['TotalRecovered']}'''
...
:flag_{country_code}: **Country:** {data['Country']}

:grey_exclamation: **Confirmed Cases:** {data['TotalConfirmed']}

:red_circle: **Deaths: ** {data['TotalDeaths']}

:green_circle: **Recoveries:** {data['TotalRecovered']}'''
            await ctx.send(re_str)
        else:
